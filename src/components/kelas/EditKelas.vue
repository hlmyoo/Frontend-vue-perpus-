                            ...
                            <div class="card card-primary card-outline">
                                <div class="card-body">
                                    <form @submit.prevent="edit">           
                                        ...
                                        <label for="buku" class="form-label">Nama kelas:</label>
                                        <input type="text" v-model="nama_kelas" class="form-control" id="kelas" placeholder="Masukkan judul buku.." autocomplete="off">
